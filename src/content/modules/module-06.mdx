...
<Figure id="6.1" src="/images/module-06/img-6-1.png" alt="Many small antenna elements coordinating their timing to turn an all-direction radio floodlight into focused beams that follow multiple users." />
