...
<ModuleNav position="top" previous={{ label: "Module 5: Spectrum", href: "/modules/5" }} current="Module 6" next={{ label: "Module 7: AI-Native Networks", href: "/modules/7" }} jumpLinks={[
...
<ModuleNav position="bottom" previous={{ label: "Back: Module 5 — Spectrum", href: "/modules/5" }} next={{ label: "Next: Module 7 — AI-Native Networks", href: "/modules/7" }} />
